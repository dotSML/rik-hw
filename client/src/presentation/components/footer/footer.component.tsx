...
export function Footer() {
  const columns = [
    ...
    {
      heading: 'Kontakt',
      containerClass: 'ml-20 col-span-2',
      renderContent: () => (
        <div className="flex gap-4">
          <div className="flex flex-col">
            <div className="flex">
              <p className="font-bold">Peakontor:&nbsp;</p>
              <p className="font-bold">Tallinnas</p>
            </div>
            <p>Väike-Ameerika 11415 Tallinn</p>
            <div className="flex">
              <p>Telefon:</p>
              <p>605 4450</p>
            </div>
          ...
          <div className="flex flex-col">
            <div className="flex">
              <p className="font-bold">Harukontor:&nbsp;</p>
              <p className="font-bold">Võrus</p>
            </div>
  ...
  return (
    <footer className="bg-darkGrey grid gap-4 grid-cols-4 p-16 py-12">
